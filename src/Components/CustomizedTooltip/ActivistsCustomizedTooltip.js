    ...
    render(){
        ...
        return(
            ...
            <div style={styles.ContentLine}>
                <span style={{color:'grey', fontSize:'15px'}}>{displayData[0]&&displayData[0].סופרפעילים}</span>
                <div>
                <span>סופר פעילים</span>
            ...
            <div style={styles.ContentLine}>
            <span style={{color:'grey', fontSize:'15px'}}>{displayData[0]&&displayData[0].רוציםלהתנדב}</span>
               <div>
                <span>רוצים להתנדב</span>
